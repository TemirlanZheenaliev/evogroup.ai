        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center">
                ...
                <div className="mb-8 animate-fade-in">
                    <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 backdrop-blur-xl border border-green-500/20 text-sm font-medium text-green-400">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto animate-slide-up" style={{animationDelay: '0.6s'}}>
                    {translations.stats.map((stat, index) => (
                        <div
                            key={index}
                            className="group p-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 hover:bg-white/10 hover:border-green-500/30 transition-all duration-500 hover:scale-105"
                        >
